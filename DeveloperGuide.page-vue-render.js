...
with(this){return _c('ol',[_c('li',[_v("User lists out the customers.")]),_v(" "),_c('li',[_v("System shows the list of customers.")]),_v(" "),_c('li',[_v("User edits the customer with the index number shown in the displayed customer list and provides the field prefix along with the new details.")]),_v(" "),_c('li',[_v("System displays the details of the deleted person."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")]),_c('br'),_v("\n4a. Index provided by user or information provided by user is invalid."),_c('br'),_v("\n 4a1. System shows an error message to alert User about the invalid command."),_c('br'),_v("\n   Use case ends.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Wed, 25 Oct 2023, 14:49:58 GMT+8]")])])])}
}];
