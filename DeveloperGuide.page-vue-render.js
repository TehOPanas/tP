...
with(this){return _c('h4',{attrs:{"id":"adding-a-person"}},[_v("Adding a person"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#adding-a-person","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
...
with(this){return _c('ol',[_c('li',[_v("User enters the details of person to be added.")]),_v(" "),_c('li',[_v("AddressBook adds the person.")]),_v(" "),_c('li',[_v("AddressBook displays the details of person added to user."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")]),_c('br'),_v("\n2a.  Details provided by user is incomplete or invalid."),_c('br'),_v("\n 2a1. AddressBook shows an error message to alert User."),_c('br'),_v("\n   Use case ends.")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"filter-contacts"}},[_v("Filter contacts"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#filter-contacts","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use case: UC02 - filter contacts")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User chooses to filter contacts.")]),_v(" "),_c('li',[_v("User enters filter command and selectively adds one/multiple category parameters to filter the contacts for.")]),_v(" "),_c('li',[_v("AddressBook filters the contacts list.")]),_v(" "),_c('li',[_v("AddressBook displays the list of contacts that meet the criteria.\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")]),_c('br'),_v("\n2b.  User doesn't select any categories to filter for."),_c('br'),_v("\n 2b1. AddressBook shows an error message to alert User about the invalid command.\n   Use case ends.")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"delete-a-person"}},[_v("Delete a person"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#delete-a-person","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: UC03 - delete a person")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User lists out the persons.")]),_v(" "),_c('li',[_v("AddressBook shows the list of persons to user.")]),_v(" "),_c('li',[_v("User deletes the person with the index number shown in the displayed list.")]),_v(" "),_c('li',[_v("AddressBook displays the details of the deleted person."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")]),_c('br'),_v("\n4a. Invalid delete command or invalid index."),_c('br'),_v("\n 4a1. AddressBook shows an error message to alert User about the invalid command."),_c('br'),_v("\n   Use case ends.")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"editing-a-person"}},[_v("Editing a person"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#editing-a-person","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: UC04 - edit a person's information")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User lists out the contact.")]),_v(" "),_c('li',[_v("AddressBook shows the list of contacts.")]),_v(" "),_c('li',[_v("User edits the person with the index number shown in the displayed person list and provide information to edit.")]),_v(" "),_c('li',[_v("AddressBook displays the details of the deleted person."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")]),_c('br'),_v("\n4a. Index provided by user is valid or information provided by user is invalid."),_c('br'),_v("\n 4a1. AddressBook shows an error message to alert User about the invalid command."),_c('br'),_v("\n   Use case ends.")])}
},function anonymous(
) {
with(this){return _c('h4',{attrs:{"id":"searching-for-a-person"}},[_v("Searching for a person"),_c('a',{staticClass:"fa fa-anchor",attrs:{"href":"#searching-for-a-person","onclick":"event.stopPropagation()"}})])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Use Case: UC05 - search for a person")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("MSS:")])])}
},function anonymous(
) {
with(this){return _c('ol',[_c('li',[_v("User searches with a prompt.")]),_v(" "),_c('li',[_v("AddressBook shows a list of person matching the prompt.")]),_v(" "),_c('li',[_v("User views the person's information."),_c('br'),_v("\nUse case ends.")])])}
},function anonymous(
) {
with(this){return _c('p',[_c('strong',[_v("Extensions:")]),_c('br'),_v("\n1a. User searches with an invalid prompt format"),_c('br'),_v("\n 1a1. AddressBook shows an error message to User."),_c('br'),_v("\n    Use case ends.")])}
},function anonymous(
) {
with(this){return _c('p',[_v("2a. There is no person that match the prompt."),_c('br'),_v("\n 2a1. AddressBook shows an empty list."),_c('br'),_v("\n    Use case ends.")])}
},function anonymous(
) {
...
with(this){return _c('footer',[_c('div',{staticClass:"text-center"},[_c('small',[_v("["),_c('span',[_c('strong',[_v("Powered by")])]),_v(" "),_c('img',{attrs:{"src":"https://markbind.org/favicon.ico","width":"30"}}),_v(" "),_c('a',{attrs:{"href":"https://markbind.org/"}},[_v("MarkBind 5.1.0")]),_v(", generated on Mon, 16 Oct 2023, 14:41:50 GMT+8]")])])])}
}];
